...
export const Eventos = () => {
  ...
  return (
    <div className="container">
      <div className="title"><h1>Eventos</h1> <div className="search"><input type="text" placeholder="Buscar Eventos" onChange={ e => setSearch(e.target.value)} /> <button onClick={SearchEvent}><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
