...
export const GerenciarEventos = () => {
  ...
  return (
    <div className="container">
      <div className="title"><h1>Eventos Criados</h1>      <LinkButton to='/CriarEvento' text='Criar novo evento?' /> <div className="search"><input type="text" placeholder="Buscar Eventos" /> <button><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
